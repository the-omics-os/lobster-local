"""Setup script for Lobster AI - Local Version."""
...
# Core requirements - same as original but with lobster-core dependency
install_requires = [
    # Core dependency
    "lobster-core>=0.1.0",
...
setup(
    name="lobster",  # Keep same name for backward compatibility
    version=version,
    author="Homara AI",
    author_email="support@homara.ai",
    description="Multi-Agent Bioinformatics Analysis System - Local Version",
    ...
    keywords="bioinformatics, RNA-seq, single-cell, AI, machine-learning, data-analysis, genomics, local",
)
